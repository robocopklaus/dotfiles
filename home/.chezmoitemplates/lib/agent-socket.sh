...
# render time (ADR 0005): the gate refuses on its absence and P7 declines to rewrite
# the source remote without it, and a path those two could spell differently is a
